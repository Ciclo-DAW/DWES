...
namespace GameStore.Controllers
{
    public class PerifericosController : Controller
    {
        ...
        public async Task<IActionResult> ListAll(int? id)
        {
            ...
            var resultados = await _context.Perifericos
                .Include(p => p.Tienda)
                .Include(p => p.Marca)
                .Where(p => p.Modelo == periferico.Modelo)
                .ToListAsync(); //Devolver todos los resultados en los que el nombre es igual al nombre del juego actual
