...
namespace CIFPACarballeiraWeb.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,NumSerie,TipoMaterial,Descripcion,Cantidad,Proveedor,FechaRecepcion,FechaGarantia,FechaRetirada,InfoGarantia,TipoUso,Estado,DepartamentoId,UbicacionId")] Material material)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,NumSerie,TipoMaterial,Descripcion,Cantidad,Proveedor,FechaRecepcion,FechaGarantia,FechaRetirada,InfoGarantia,TipoUso,Estado,DepartamentoId,UbicacionId")] Material material)
        {
            if (id != material.ID)
            {
                return NotFound();
