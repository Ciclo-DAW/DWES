...
namespace GameStore.Controllers
{
    public class ConsolasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Marca,Modelo,Descripcion,Cantidad,Precio,FechaSalida,Estado")] Consola consola)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Marca,Modelo,Descripcion,Cantidad,Precio,FechaSalida,Estado")] Consola consola)
        {
            if (id != consola.ID)
            {
                return NotFound();
